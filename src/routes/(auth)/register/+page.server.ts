...
export const actions: Actions = {
	register: async ({ request }) => {
		...
		const username: string | undefined = data.get('username')?.toString().trim();
		const fullname: string | undefined = data.get('fullname')?.toString().trim();
		...
		console.log(username, fullname, email, address, phone, password, repeatPassword);
