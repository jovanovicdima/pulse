...
<div class="flex w-full flex-col items-center gap-4 p-10 grow justify-center">
	<div class="flex flex-col items-center gap-2">
		<p class="text-3xl text-primary-500">Welcome back!</p>
	...
	>
		<div class="flex w-full flex-col">
			<input
				class="w-full px-4 py-2 pr-10 border rounded-lg text-background"
				type="text"
				name="username"
				id="username"
    ...
    {/if} -->
		...
		<button type="submit" class="border-primary-500 border bg-primary-500 px-4 py-2 rounded-lg text-background select-none cursor-pointer">Log in</button>
	</form>
  <p class="text-center mt-4">
    Don’t have an account? <a class="text-primary-500" href="/register">Sign up.</a>
  </p>
</div>
